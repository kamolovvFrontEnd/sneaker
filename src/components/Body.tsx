...
import cart from "../assetsBody/cart.svg";
          ...
          <div className="ms-8">
            ...
            <h2 className="relative mt-0">
              ...
              <div className="mt-4 flex">
                <button className="button-style me-4">
                  <img src={cart} alt="cart" className="my-auto me-2" />
                  <span className="my-4">В корзину</span>
                </button>
                <button className="button-heart-style">
